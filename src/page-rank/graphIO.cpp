...
using EdgeType = uint64_t;
using VtxType = uint32_t;
...
template bool ReadGraph<uint32_t, uint64_t, int> (char *filename, uint32_t *numofvertex, uint64_t **pxadj, uint32_t **padjncy, uint32_t ** ptadj, int **padjncyw, int **ppvw, long** reverse_map);

template bool ReadGraph<uint32_t, uint64_t, float> (char *filename, uint32_t *numofvertex, uint64_t **pxadj, uint32_t **padjncy, uint32_t ** ptadj, float **padjncyw, float **ppvw, long** reverse_map);
